...
public class ChatCompletionRequest {
     ...
     * the model considers the results of the tokens
     * with top_p probability mass. So 0.1 means only the tokens comprising the top
     * 10% probability mass are considered.<br>
    ...
    /**
     * How many chat completion chatCompletionChoices to generate for each input
     * message.
     */
    Integer n;
     ...
     * events</a> as they become available, with the stream terminated by a data:
     * [DONE] message.
     */
    Boolean stream;
     ...
     * the number of tokens the model can return will
     ...
     * model prior to sampling. The exact effect will
     * vary per model, but values between -1 and 1 should decrease or increase
     * likelihood of selection; values like -100 or 100
    ...
    /**
     * Controls how the model responds to function calls, as specified in the
     * <a href=
     * "https://platform.openai.com/docs/api-reference/chat/create#chat/create-function_call">OpenAI
     * documentation</a>.
     */
